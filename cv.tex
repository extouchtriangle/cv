...
Strong background in algebra, combinatorics, number theory,
Euclidean geometry, linear algebra, and multivariable calculus.
\vskip 0.1in
...
Python, Arch Linux and Ubuntu Linux
...
\section{Hobbies}
Tennis, Violin, Computer Programming
\end{document}
